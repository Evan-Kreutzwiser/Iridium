...
#define SYSCALL_OBJECT_WAIT 27

#define SYSCALL_CHANNEL_CREATE 28
#define SYSCALL_CHANNEL_READ 29
#define SYSCALL_CHANNEL_WRITE 30
...
char *syscall_names[] = {
    ...
    [SYSCALL_OBJECT_WAIT] = "SYSCALL_OBJECT_WAIT"
};
